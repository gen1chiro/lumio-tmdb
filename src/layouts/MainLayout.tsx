...
function MainLayout() {
    ...
    return (
        <div className='h-screen flex flex-col'>
            ...
            <div
                className='w-11/12 max-w-7xl flex flex-col gap-6 mt-4 sm:mt-24 mb-10 p-2 bg-white dark:bg-zinc-800 shadow-xl border border-gray-100 dark:border-zinc-700 mx-auto rounded-2xl'>
